...
namespace EmotivUnityPlugin
{
    public class BCIGameItf
    {
        ...
        /// <param name="band">The band power type such as BandPowerType.Theta, BandPowerType.Alpha, BandPowerType.LowBeta, BandPowerType.HighBeta, BandPowerType.Gamma.</param>
